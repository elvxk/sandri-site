    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="font-bold text-lg text-cdark dark:text-cwhite flex justify-center items-center gap-2 [writing-mode:vertical-lr] font-blinker">
            <a
              id="navhome"
              href="#home"
              className="rotate-180 group overflow-hidden relative transition-all px-4 hover:text-cwhite [&.active]:text-cwhite [&.active]:hover:text-cwhite dark:[&.active]:text-cwhite dark:[&.active]:hover:text-cwhite active"
            >
              Home
              <span
                id="dhome"
            ...
            <a
              id="navabout"
              href="#about"
              className="rotate-180 group overflow-hidden relative transition-all px-4 hover:text-cwhite [&.active]:text-cwhite [&.active]:hover:text-cwhite dark:[&.active]:text-cwhite dark:[&.active]:hover:text-cwhite"
            >
              About
              <span
                id="dabout"
        ...
        <div
          data-aos="fade-right"
          data-aos-delay="400"
          className="flex flex-col justify-between gap-5 items-center text-xl text-cdark dark:text-cwhite"
        >
          <a
      ...
      <nav
        className={`fixed right-11 top-14 bottom-14 hidden lg:flex flex-col gap-10 justify-between items-center z-30 transition-all`}
      >
        <div data-aos="fade-left" data-aos-delay="400">
          <ThemeSwitcher className="scale-149 hover:rotate-[20deg] transition-all text-cdark dark:text-cwhite hover:text-cpink dark:hover:text-ccyan hover:cursor-pointer" />
        </div>
      </nav>
    </>
  );
